...
public static wrapText(fontData, scale, text, maxWidth):string {
...
public static linesText(fontData, scale, text, maxWidth):string[] {
...
public static scanLine (data, scale, text, maxWidth) {
